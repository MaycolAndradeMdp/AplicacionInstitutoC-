...
namespace HILET
{
    public partial class frmConfirmacionPerfilProfesores : Form
    {
        bool ocultar = true;
        bool error = false;
        string UsuarioNuevo;
        ...
        public frmConfirmacionPerfilProfesores(string Contraseña)
        {
            InitializeComponent();
        ...
        private async void btnGuardarPerfil_Click_1(object sender, EventArgs e)
        {
            ...
            {
                conectar.Abrir();
                string consulta = "ModificarUsuarioProfesores";
